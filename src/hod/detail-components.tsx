...
import type { LecturerClass, LecturerStudent, SessionSummary } from '@/lecturer/types';
...
export function AttendanceAction({ classId }: { classId: string }) {
  return <Button label="Start attendance" onPress={() => router.push(`/hod/classes/${classId}/attendance` as Href)} />;
}
