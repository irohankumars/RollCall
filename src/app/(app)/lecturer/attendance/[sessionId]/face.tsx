...
export default function LiveAttendance() {
  ...
  const endSession = () => {
    ...
    setConfirmEnd(false);
    router.replace(`/lecturer/attendance/${sessionId}/review?${query}` as Href);
  };

  return <LecturerShell activeKey="classes" title="Live attendance" subtitle={item?.subjectCode} back backFallback={`/lecturer/classes/${classId}` as Href}>
