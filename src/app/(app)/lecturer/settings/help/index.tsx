...
export default function HelpSupport() {
  ...
  return <LecturerShell activeKey="settings" title="Help & Support" subtitle="Answers and assistance" back backFallback="/lecturer/settings">
    <PageContainer width="compact">
      ...
      <View style={{ gap: spacing.sm }}>
        ...
        <SettingsRow icon="chatbubble-ellipses-outline" title="Contact support" detail="See the support channels available to you" onPress={() => router.push('/lecturer/settings/help/contact' as Href)} />
        <SettingsRow icon="flag-outline" title="Report a problem" detail="Describe an issue for the support team" onPress={() => router.push('/lecturer/settings/help/report' as Href)} last />
      </View>
