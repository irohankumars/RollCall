...
import { ClassDetailHeader, DetailPageSkeleton, StudentRosterRow, StudentSearch } from '@/lecturer/detail-components';
...
export default function Roster() {
  ...
  return <LecturerShell activeKey="classes" title="Students" subtitle={item ? `${item.subjectName} · ${item.batchName}` : undefined} back backFallback={`/lecturer/classes/${classId}` as Href}>
