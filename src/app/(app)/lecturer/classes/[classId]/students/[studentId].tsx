...
export default function StudentDetail() {
  ...
  return <LecturerShell activeKey="classes" title="Student" subtitle={item?.rollNumber} back backFallback={`/lecturer/classes/${classId}/students` as Href}>
    <PageContainer width="detail">
      ...
      {!loading && item && classItem ? <>
        ...
        <Button label="View history" variant="secondary" accessibilityHint="Opens the existing lecturer attendance history" onPress={() => router.push('/lecturer/history' as Href)} />
      </> : null}
    </PageContainer>
  </LecturerShell>;
}
