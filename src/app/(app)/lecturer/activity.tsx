...
const activities: readonly LecturerActivityItem[] = [
  { id: 'a1', category: 'ATTENDANCE', title: 'Attendance completed', context: 'Machine Learning · CSE 2024 A', timestamp: '10:42 AM', group: 'Today', icon: 'checkmark-circle-outline', destination: '/lecturer/history' },
  { id: 'a2', category: 'ACCOUNT', title: 'Profile updated', context: 'Lecturer profile', timestamp: '9:15 AM', group: 'Today', icon: 'person-outline', destination: '/lecturer/profile' },
  { id: 'a3', category: 'ATTENDANCE', title: 'Attendance reviewed', context: 'Artificial Intelligence · CSE 2024 A', timestamp: '4:20 PM', group: 'Yesterday', icon: 'document-text-outline', destination: '/lecturer/history' },
  { id: 'a4', category: 'ACCOUNT', title: 'Appearance changed', context: 'Dark theme selected', timestamp: '2:05 PM', group: 'Yesterday', icon: 'contrast-outline', destination: '/lecturer/settings/appearance' },
  { id: 'a5', category: 'ACCOUNT', title: 'Sign-in method updated', context: 'Google connected', timestamp: 'Sep 18', group: 'Earlier', icon: 'key-outline', destination: '/lecturer/settings/security/sign-in-methods' },
];
...
export default function LecturerActivity() {
  ...
  return <LecturerShell activeKey="activity" title="Activity" subtitle="Your recent RollCall activity" back backFallback={'/lecturer/profile' as Href}>
